...
<v-app id="u">    
    <v-data-table :headers="headers" :items="representantes" :search="search" sort-by="id_representante" class="elevation-3">     
      <template v-slot:top>    
        ...
        <v-toolbar flat color="indigo">
          ...
          <v-toolbar-title class="white--text">Representantes</v-toolbar-title>
              ...
              <v-card-text>                  
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editado.celular" label="celular"></v-text-field>
                    </v-col>
