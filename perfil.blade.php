...
<v-app id="u">    
    <v-data-table :headers="headers" :items="usuarios" :search="search" sort-by="id_usuario" class="elevation-3">     
      <template v-slot:top>    
              ...
              <v-card-text>                  
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editado.apellido_p" label="Apellido Paterno"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editado.apellido_m" label="Apellido Materno"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editado.correo" label="Correo"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editado.usuario" label="Usuario"></v-text-field>

                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editado.contrasenia" label="Contraseña"></v-text-field>
