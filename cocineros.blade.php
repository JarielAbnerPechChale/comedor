...
<v-app id="emp">    
    <v-data-table :headers="headers" :items="empleados" :search="search" sort-by="id_empleado" class="elevation-3">     
      <template v-slot:top>    
        ...
        <v-toolbar flat color="indigo">
          ...
          <v-toolbar-title class="white--text">Ecónomos</v-toolbar-title>
              ...
              <v-card-text>                  
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editado.apellidop" label="Apellido Paterno"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editado.apellidom" label="Apellido Materno"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editado.celular" label="No. Celular"></v-text-field>
                    </v-col>
...
<center><a href="index.blade.php">REGRESAR</a></center><br>
  ...
  <script src="cocineros.js"></script>
</body>
</html>