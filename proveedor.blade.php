...
<v-app id="pro">    
    <v-data-table :headers="headers" :items="proveedores" :search="search" sort-by="id_proveedor" class="elevation-3">     
      <template v-slot:top>    
        ...
        <v-toolbar flat color="indigo">
          ...
          <v-toolbar-title class="white--text">Proveedores</v-toolbar-title>
