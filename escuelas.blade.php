...
<v-app id="esc">    
    <v-data-table :headers="headers" :items="escuelas" :search="search" sort-by="id_escuela" class="elevation-3">     
      <template v-slot:top>    
        ...
        <v-toolbar flat color="indigo">
          ...
          <v-toolbar-title class="white--text">Escuelas</v-toolbar-title>
              ...
              <v-card-text>                  
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editado.clave_escuela" label="Clave"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editado.direccion" label="Dirección"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
